...
class LBNand: LBGate {
    ...
    override init(withDefaultSize size: CGSize) {
        ...
        var pin1 = LBPinType(x: 0, y: 20-LBPinType.size/2); pin1.facing = .left; pin1.type = .input
        var pin2 = pin1; pin2.pos = CGPoint(x: 0, y: 50-LBPinType.size/2)
        var pin3 = LBPinType(x: 118, y: 34-LBPinType.size/2); pin3.facing = .right; pin3.type = .output
        pins = [pin1, pin2, pin3]
    }
