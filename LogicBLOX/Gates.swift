...
//  LogicBLOX
//
//  Created by Mike Griebling on 17 Sep 2017.
...
public class Gates : NSObject {
    ...
    @objc dynamic public class func drawButton(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 95, height: 69), resizing: ResizingBehavior = .aspectFit, highlight: Bool = false, state: CGFloat = 0, outputPinVisible: Bool = true, name: String = "Block Gate") {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()!
    ...
    @objc dynamic public class func drawIndicator(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 94, height: 73), resizing: ResizingBehavior = .aspectFit, highlight: Bool = false, state: CGFloat = 0, inputPinVisible: CGFloat = 2, name: String = "Block Gate") {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()!
        ...
        //// Group
        //// Oval Drawing
        let ovalPath = UIBezierPath(ovalIn: CGRect(x: 27, y: 19, width: 49, height: 47))
        context.saveGState()
        context.setShadow(offset: CGSize(width: shadow.shadowOffset.width * resizedShadowScale, height: shadow.shadowOffset.height * resizedShadowScale), blur: shadow.shadowBlurRadius * resizedShadowScale, color: (shadow.shadowColor as! UIColor).cgColor)
        context.beginTransparencyLayer(auxiliaryInfo: nil)
        ovalPath.addClip()
        context.drawRadialGradient(gradientFill,
            startCenter: CGPoint(x: 47.38, y: 34.04), startRadius: 5.1,
