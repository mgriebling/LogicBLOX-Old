...
//  LogicBLOX
//
//  Created by Mike Griebling on 20 Sep 2017.
...
public class Gates : NSObject {
    ...
    @objc dynamic public class func drawOrNorGate(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 135, height: 67), resizing: ResizingBehavior = .aspectFit, highlight: Bool = false, inputs: CGFloat = 4, inputPinVisible: CGFloat = 1, outputPinVisible: Bool = true, invert: Bool = true) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()!
    ...
    @objc dynamic public class func drawXorXnorGate(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 143, height: 67), resizing: ResizingBehavior = .aspectFit, highlight: Bool = false, inputs: CGFloat = 4, inputPinVisible: CGFloat = 1, outputPinVisible: Bool = true, invert: Bool = true) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()!
    ...
    @objc dynamic public class func drawBufferInverterGate(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 102, height: 57), resizing: ResizingBehavior = .aspectFit, highlight: Bool = false, inputPinVisible: CGFloat = 1, outputPinVisible: Bool = true, invert: Bool = true) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()!
    ...
    @objc dynamic public class func drawAndNandGate(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 134, height: 68), resizing: ResizingBehavior = .aspectFit, highlight: Bool = false, pinVisible: Bool = true, inputs: CGFloat = 4, inputPinVisible: CGFloat = 1, invert: Bool = true) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()!
    ...
    @objc dynamic public class func drawButton(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 57, height: 35), resizing: ResizingBehavior = .aspectFit, highlight: Bool = false, state: CGFloat = 0, outputPinVisible: Bool = true) {
        ...
        //// Group
        //// Rectangle Drawing
        let rectangleRect = CGRect(x: 4.5, y: 5.5, width: 25, height: 21)
    ...
    @objc dynamic public class func drawIndicator(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 57, height: 35), resizing: ResizingBehavior = .aspectFit, highlight: Bool = false, state: CGFloat = 0, inputPinVisible: CGFloat = 1) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()!
    ...
    @objc dynamic public class func drawOrPins(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 31, height: 56), resizing: ResizingBehavior = .aspectFit, highlight: Bool = false, inputs: CGFloat = 4, inputPinVisible: CGFloat = 1) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()!
    ...
    @objc dynamic public class func drawAndPins(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 30, height: 56), resizing: ResizingBehavior = .aspectFit, highlight: Bool = false, inputs: CGFloat = 4, inputPinVisible: CGFloat = 1) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()!
    ...
    @objc dynamic public class func imageOfOrNorGate(highlight: Bool = false, inputs: CGFloat = 4, inputPinVisible: CGFloat = 1, outputPinVisible: Bool = true, invert: Bool = true) -> UIImage {
    ...
    @objc dynamic public class func imageOfXorXnorGate(highlight: Bool = false, inputs: CGFloat = 4, inputPinVisible: CGFloat = 1, outputPinVisible: Bool = true, invert: Bool = true) -> UIImage {
    ...
    @objc dynamic public class func imageOfBufferInverterGate(highlight: Bool = false, inputPinVisible: CGFloat = 1, outputPinVisible: Bool = true, invert: Bool = true) -> UIImage {
    ...
    @objc dynamic public class func imageOfAndNandGate(highlight: Bool = false, pinVisible: Bool = true, inputs: CGFloat = 4, inputPinVisible: CGFloat = 1, invert: Bool = true) -> UIImage {
    ...
    @objc dynamic public class func imageOfIndicator(highlight: Bool = false, state: CGFloat = 0, inputPinVisible: CGFloat = 1) -> UIImage {
        UIGraphicsBeginImageContextWithOptions(CGSize(width: 57, height: 35), false, 0)
