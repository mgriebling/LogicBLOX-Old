...
public class Gates : NSObject {
    ...
    @objc dynamic public class func drawOrNorGate(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 124, height: 60), resizing: ResizingBehavior = .aspectFit, highlight: Bool = false, inputs: CGFloat = 4, joinedPin: CGFloat = 0, joinedOutputPin: CGFloat = 0, inputPinVisible: CGFloat = 0, outputPinVisible: CGFloat = 0, invertInput: CGFloat = 0, invert: Bool = true) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()!
    ...
    @objc dynamic public class func drawBufferInverterGate(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 90, height: 52), resizing: ResizingBehavior = .aspectFit, highlight: Bool = false, joinedPin: CGFloat = 0, joinedOutputPin: CGFloat = 0, inputPinVisible: CGFloat = 0, outputPinVisible: CGFloat = 0, invert: Bool = true) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()!
    ...
    @objc dynamic public class func drawAndNandGate(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 120, height: 60), resizing: ResizingBehavior = .aspectFit, highlight: Bool = false, inputs: CGFloat = 4, joinedPin: CGFloat = 0, joinedOutputPin: CGFloat = 0, inputPinVisible: CGFloat = 0, outputPinVisible: CGFloat = 0, invertInput: CGFloat = 0, invert: Bool = true) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()!
    ...
    @objc dynamic public class func drawButton(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 52, height: 32), resizing: ResizingBehavior = .aspectFit, highlight: Bool = false, state: CGFloat = 0, joinedOutputPin: CGFloat = 0, outputPinVisible: CGFloat = 0) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()!
    ...
    @objc dynamic public class func drawOrPins(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 39, height: 60), resizing: ResizingBehavior = .aspectFit, highlight: Bool = false, inputs: CGFloat = 4, joinedPin: CGFloat = 0, inputPinVisible: CGFloat = 0, invertInput: CGFloat = 0) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()!
    ...
    @objc dynamic public class func drawAndPins(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 25, height: 56), resizing: ResizingBehavior = .aspectFit, highlight: Bool = false, inputs: CGFloat = 4, joinedPin: CGFloat = 0, inputPinVisible: CGFloat = 0, invertInput: CGFloat = 0) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()!
    ...
    @objc dynamic public class func drawTristateBufferInverter(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 92, height: 64), resizing: ResizingBehavior = .aspectFit, highlight: Bool = false, joinedPin: CGFloat = 0, joinedOutputPin: CGFloat = 0, inputPinVisible: CGFloat = 0, outputPinVisible: CGFloat = 0, invertInput: CGFloat = 0, invert: Bool = true) {
        ...
        Gates.drawBufferInverterGate(frame: CGRect(origin: .zero, size: symbolRect.size), resizing: .stretch, highlight: highlight, joinedPin: joinedPin, joinedOutputPin: joinedOutputPin, inputPinVisible: inputPinVisible, outputPinVisible: outputPinVisible, invert: invert)
        context.restoreGState()
    ...
    @objc dynamic public class func drawOutput(frame: CGRect = CGRect(x: 0, y: 0, width: 112, height: 30), highlight: Bool = false, joinedPin: CGFloat = 0, inputPinVisible: CGFloat = 0, name: String = "I/O 1") {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()!
        // This non-generic function dramatically improves compilation times of complex expressions.
        func fastFloor(_ x: CGFloat) -> CGFloat { return floor(x) }
        ...
        rectanglePath.addLine(to: CGPoint(x: frame.maxX - 3, y: frame.minY + 0.48148 * frame.height))
        ...
        //// Text Drawing
        let textRect = CGRect(x: frame.minX + 29, y: frame.minY + fastFloor(frame.height * 0.13333 + 0.5), width: fastFloor((frame.width - 29) * 0.79518 + 0.5), height: fastFloor(frame.height * 0.83333 + 0.5) - fastFloor(frame.height * 0.13333 + 0.5))
    ...
    @objc dynamic public class func drawInput(frame: CGRect = CGRect(x: 0, y: 0, width: 111, height: 30), highlight: Bool = false, joinedOutputPin: CGFloat = 0, outputPinVisible: CGFloat = 0, name: String = "I/O 1") {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()!
        // This non-generic function dramatically improves compilation times of complex expressions.
        func fastFloor(_ x: CGFloat) -> CGFloat { return floor(x) }
    ...
    @objc dynamic public class func drawOscillator(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 51, height: 32), resizing: ResizingBehavior = .aspectFit, highlight: Bool = false, joinedOutputPin: CGFloat = 0, outputPinVisible: CGFloat = 0) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()!
