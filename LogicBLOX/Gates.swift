...
//  LogicBLOX
//
//  Created by Mike Griebling on 29 Sep 2017.
...
public class Gates : NSObject {
    ...
    @objc dynamic public class func drawOrNorGate(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 132, height: 67), resizing: ResizingBehavior = .aspectFit, highlight: Bool = false, inputs: CGFloat = 4, joinedPin: CGFloat = 0, joinedOutputPin: CGFloat = 0, inputPinVisible: CGFloat = 0, outputPinVisible: CGFloat = 1, invert: Bool = true) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()!
    ...
    @objc dynamic public class func drawXorXnorGate(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 143, height: 67), resizing: ResizingBehavior = .aspectFit, highlight: Bool = false, inputs: CGFloat = 4, joinedPin: CGFloat = 0, joinedOutputPin: CGFloat = 0, inputPinVisible: CGFloat = 0, outputPinVisible: CGFloat = 1, invert: Bool = true) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()!
    ...
    @objc dynamic public class func drawBufferInverterGate(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 102, height: 56), resizing: ResizingBehavior = .aspectFit, highlight: Bool = false, joinedPin: CGFloat = 0, joinedOutputPin: CGFloat = 0, inputPinVisible: CGFloat = 0, outputPinVisible: CGFloat = 1, invert: Bool = true) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()!
        
        //// Resize to Target Frame
        context.saveGState()
        let resizedFrame: CGRect = resizing.apply(rect: CGRect(x: 0, y: 0, width: 102, height: 56), target: targetFrame)
        context.translateBy(x: resizedFrame.minX, y: resizedFrame.minY)
        context.scaleBy(x: resizedFrame.width / 102, y: resizedFrame.height / 56)
        ...
        //// Group
        //// Symbol Drawing
        let symbolRect = CGRect(x: 21, y: 0, width: 49, height: 57)
        context.saveGState()
        context.clip(to: symbolRect)
        context.translateBy(x: symbolRect.minX, y: symbolRect.minY)
    ...
    @objc dynamic public class func drawAndNandGate(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 134, height: 68), resizing: ResizingBehavior = .aspectFit, highlight: Bool = false, inputs: CGFloat = 4, joinedPin: CGFloat = 0, joinedOutputPin: CGFloat = 0, inputPinVisible: CGFloat = 0, outputPinVisible: CGFloat = 1, invert: Bool = true) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()!
    ...
    @objc dynamic public class func drawIndicator(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 57, height: 35), resizing: ResizingBehavior = .aspectFit, highlight: Bool = false, state: CGFloat = 0, joinedPin: CGFloat = 0, inputPinVisible: CGFloat = 0) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()!
    ...
    @objc dynamic public class func drawOrPins(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 31, height: 56), resizing: ResizingBehavior = .aspectFit, highlight: Bool = false, inputs: CGFloat = 4, joinedPin: CGFloat = 0, inputPinVisible: CGFloat = 0) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()!
        ...
        if (hasInputs2) {
            ...
            bezier6Path.move(to: CGPoint(x: 2, y: 40))
            bezier6Path.addLine(to: CGPoint(x: 27, y: 40))
            colour.setStroke()
            ...
            //// Symbol 2 Drawing
            let symbol2Rect = CGRect(x: 0, y: 36, width: 27, height: 8)
            context.saveGState()
            context.clip(to: symbol2Rect)
            context.translateBy(x: symbol2Rect.minX, y: symbol2Rect.minY)
            context.translateBy(x: 4, y: 4)
            ...
            bezier5Path.move(to: CGPoint(x: 2, y: 16))
            bezier5Path.addLine(to: CGPoint(x: 27, y: 16))
            colour.setStroke()
        ...
        if (hasInputs3) {
            ...
            //// Bezier 3 Drawing
            let bezier3Path = UIBezierPath()
            bezier3Path.move(to: CGPoint(x: 2, y: 48))
            bezier3Path.addLine(to: CGPoint(x: 25, y: 48))
            colour.setStroke()
            bezier3Path.lineWidth = 2.5
            bezier3Path.stroke()
            ...
            //// Symbol 4 Drawing
            let symbol4Rect = CGRect(x: 0, y: 44, width: 26, height: 8)
            context.saveGState()
            context.clip(to: symbol4Rect)
            context.translateBy(x: symbol4Rect.minX, y: symbol4Rect.minY)
            context.translateBy(x: 4, y: 4)
            ...
            //// Bezier 2 Drawing
            let bezier2Path = UIBezierPath()
            bezier2Path.move(to: CGPoint(x: 2, y: 28))
            ...
            //// Symbol 5 Drawing
            let symbol5Rect = CGRect(x: 0, y: 24, width: 27, height: 8)
            context.saveGState()
        ...
        if (hasInputs4) {
            ...
            Gates.drawInputPin(frame: CGRect(origin: .zero, size: symbol9Rect.size), resizing: .stretch, highlight: highlight, pinVisible: pin3or4Visible, isJoined: pin3or4Joined)
            context.restoreGState()
            ...
            bezier8Path.move(to: CGPoint(x: 2, y: 36))
            bezier8Path.addLine(to: CGPoint(x: 28, y: 36))
            colour.setStroke()
            ...
            //// Symbol 7 Drawing
            let symbol7Rect = CGRect(x: 0, y: 32, width: 27, height: 8)
            context.saveGState()
            ...
            bezier7Path.move(to: CGPoint(x: 2, y: 20))
            bezier7Path.addLine(to: CGPoint(x: 28, y: 20))
            colour.setStroke()
            ...
            //// Symbol 6 Drawing
            let symbol6Rect = CGRect(x: 0, y: 16, width: 27, height: 8)
            context.saveGState()
            ...
            Gates.drawInputPin(frame: CGRect(origin: .zero, size: symbol8Rect.size), resizing: .stretch, highlight: highlight, pinVisible: pin1Visible, isJoined: pin1Joined)
            context.restoreGState()
    ...
    @objc dynamic public class func drawAndPins(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 30, height: 56), resizing: ResizingBehavior = .aspectFit, highlight: Bool = false, inputs: CGFloat = 4, joinedPin: CGFloat = 0, inputPinVisible: CGFloat = 0) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()!
        ...
        if (hasInputs4) {
            ...
            Gates.drawInputPin(frame: CGRect(origin: .zero, size: _4Pin4Rect.size), resizing: .stretch, highlight: highlight, pinVisible: pin3or4Visible, isJoined: pin3or4Joined)
            context.restoreGState()


            //// 4Pin3 Drawing
            let _4Pin3Rect = CGRect(x: 0, y: 32, width: 27, height: 8)
            context.saveGState()
            context.clip(to: _4Pin3Rect)
            context.translateBy(x: _4Pin3Rect.minX, y: _4Pin3Rect.minY)
            context.translateBy(x: 4, y: 4)

            Gates.drawInputPin(frame: CGRect(origin: .zero, size: _4Pin3Rect.size), resizing: .stretch, highlight: highlight, pinVisible: pin3Visible, isJoined: pin3Joined)
            context.restoreGState()


            //// 4Pin2 Drawing
            let _4Pin2Rect = CGRect(x: 0, y: 16, width: 27, height: 8)
            context.saveGState()
            context.clip(to: _4Pin2Rect)
            context.translateBy(x: _4Pin2Rect.minX, y: _4Pin2Rect.minY)
            context.translateBy(x: 4, y: 4)

            Gates.drawInputPin(frame: CGRect(origin: .zero, size: _4Pin2Rect.size), resizing: .stretch, highlight: highlight, pinVisible: pin2Visible, isJoined: pin2Joined)
            context.restoreGState()
            ...
            Gates.drawInputPin(frame: CGRect(origin: .zero, size: _4Pin1Rect.size), resizing: .stretch, highlight: highlight, pinVisible: pin1Visible, isJoined: pin1Joined)
            context.restoreGState()
        ...
        if (hasInputs3) {
            //// In3
            //// 3Pin3 Drawing
            let _3Pin3Rect = CGRect(x: 0, y: 44, width: 27, height: 8)
            context.saveGState()
            context.clip(to: _3Pin3Rect)
            context.translateBy(x: _3Pin3Rect.minX, y: _3Pin3Rect.minY)
            context.translateBy(x: 4, y: 4)

            Gates.drawInputPin(frame: CGRect(origin: .zero, size: _3Pin3Rect.size), resizing: .stretch, highlight: highlight, pinVisible: pin3or4Visible, isJoined: pin3or4Joined)
            context.restoreGState()


            //// 3Pin2 Drawing
            let _3Pin2Rect = CGRect(x: 0, y: 24, width: 27, height: 8)
            context.saveGState()
            context.clip(to: _3Pin2Rect)
            context.translateBy(x: _3Pin2Rect.minX, y: _3Pin2Rect.minY)
            context.translateBy(x: 4, y: 4)

            Gates.drawInputPin(frame: CGRect(origin: .zero, size: _3Pin2Rect.size), resizing: .stretch, highlight: highlight, pinVisible: pin1or2Visible, isJoined: pin1or2Joined)
            context.restoreGState()


            //// 3Pin1 Drawing
            let _3Pin1Rect = CGRect(x: 0, y: 4, width: 27, height: 8)
            context.saveGState()
            context.clip(to: _3Pin1Rect)
            context.translateBy(x: _3Pin1Rect.minX, y: _3Pin1Rect.minY)
            context.translateBy(x: 4, y: 4)

            Gates.drawInputPin(frame: CGRect(origin: .zero, size: _3Pin1Rect.size), resizing: .stretch, highlight: highlight, pinVisible: pin1Visible, isJoined: pin1Joined)
            context.restoreGState()
        ...
        if (hasInputs2) {
            //// In2
            //// 2Pin2 Drawing
            let _2Pin2Rect = CGRect(x: 0, y: 36, width: 27, height: 8)
            context.saveGState()
            context.clip(to: _2Pin2Rect)
            context.translateBy(x: _2Pin2Rect.minX, y: _2Pin2Rect.minY)
            context.translateBy(x: 4, y: 4)

            Gates.drawInputPin(frame: CGRect(origin: .zero, size: _2Pin2Rect.size), resizing: .stretch, highlight: highlight, pinVisible: pin2Visible, isJoined: pin2Joined)
            context.restoreGState()


            //// 2Pin1 Drawing
            let _2Pin1Rect = CGRect(x: 0, y: 12, width: 27, height: 8)
            context.saveGState()
            context.clip(to: _2Pin1Rect)
            context.translateBy(x: _2Pin1Rect.minX, y: _2Pin1Rect.minY)
            context.translateBy(x: 4, y: 4)

            Gates.drawInputPin(frame: CGRect(origin: .zero, size: _2Pin1Rect.size), resizing: .stretch, highlight: highlight, pinVisible: pin1Visible, isJoined: pin1Joined)
            context.restoreGState()
    ...
    @objc dynamic public class func drawOutputPin(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 27, height: 8), resizing: ResizingBehavior = .aspectFit, highlight: Bool = false, pinVisible: Bool = true, isJoined: Bool = true) {
        ...
        bezier16Path.move(to: CGPoint(x: -23, y: 0))
        ...
        if (isJoinedOrPinVisible) {
            //// Symbol 2 Drawing
            let symbol2Rect = CGRect(x: -3, y: -3, width: 6, height: 6)
            context.saveGState()
            context.clip(to: symbol2Rect)
            context.translateBy(x: symbol2Rect.minX, y: symbol2Rect.minY)
    ...
    @objc dynamic public class func drawInvertingOutputPin(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 34, height: 18), resizing: ResizingBehavior = .aspectFit, highlight: Bool = false, pinVisible: Bool = true, isJoined: Bool = true) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()!
        
        //// Resize to Target Frame
        context.saveGState()
        let resizedFrame: CGRect = resizing.apply(rect: CGRect(x: 0, y: 0, width: 34, height: 18), target: targetFrame)
        context.translateBy(x: resizedFrame.minX, y: resizedFrame.minY)
        context.scaleBy(x: resizedFrame.width / 34, y: resizedFrame.height / 18)
        ...
        //// Bezier 16 Drawing
        let bezier16Path = UIBezierPath()
        bezier16Path.move(to: CGPoint(x: -16, y: 0))
        bezier16Path.addLine(to: CGPoint(x: 0, y: 0))
        colour.setStroke()
        bezier16Path.lineWidth = 2.5
        bezier16Path.stroke()
        ...
        //// Symbol Drawing
        let symbolRect = CGRect(x: -32, y: -9.5, width: 19, height: 19)
        context.saveGState()
        context.clip(to: symbolRect)
        context.translateBy(x: symbolRect.minX, y: symbolRect.minY)
    ...
    @objc dynamic public class func drawInputPin(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 27, height: 8), resizing: ResizingBehavior = .aspectFit, highlight: Bool = false, pinVisible: Bool = true, isJoined: Bool = true) {
        ...
        bezier16Path.addLine(to: CGPoint(x: 23, y: 0))
        colour.setStroke()
        bezier16Path.lineWidth = 2.5
        bezier16Path.stroke()
    ...
    @objc dynamic public class func drawInvertingInputPin(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 31, height: 12), resizing: ResizingBehavior = .aspectFit, highlight: Bool = false, pinVisible: Bool = true, isJoined: Bool = true) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()!
        
        //// Resize to Target Frame
        context.saveGState()
        let resizedFrame: CGRect = resizing.apply(rect: CGRect(x: 0, y: 0, width: 31, height: 12), target: targetFrame)
        context.translateBy(x: resizedFrame.minX, y: resizedFrame.minY)
        context.scaleBy(x: resizedFrame.width / 31, y: resizedFrame.height / 12)
        ...
        //// Bezier 16 Drawing
        let bezier16Path = UIBezierPath()
        bezier16Path.move(to: CGPoint(x: -0, y: -0.2))
        bezier16Path.addLine(to: CGPoint(x: 16, y: -0.2))
        colour.setStroke()
        bezier16Path.lineWidth = 2.5
        bezier16Path.stroke()
        ...
        if (isJoinedOrPinVisible) {
            //// Symbol 2 Drawing
            let symbol2Rect = CGRect(x: -3, y: -3.2, width: 6, height: 6)
            context.saveGState()
            context.clip(to: symbol2Rect)
            context.translateBy(x: symbol2Rect.minX, y: symbol2Rect.minY)
        ...
        //// Symbol Drawing
        context.saveGState()
        context.translateBy(x: 14, y: -6.5)
    ...
    @objc dynamic public class func drawTristateBufferInverter(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 102, height: 67), resizing: ResizingBehavior = .aspectFit, highlight: Bool = false, joinedPin: CGFloat = 0, joinedOutputPin: CGFloat = 0, inputPinVisible: CGFloat = 0, outputPinVisible: CGFloat = 1, invert: Bool = true) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()!
    ...
    @objc dynamic public class func drawOutput(frame: CGRect = CGRect(x: 0, y: 0, width: 135, height: 30), highlight: Bool = false, joinedPin: CGFloat = 0, inputPinVisible: CGFloat = 0, name: String = "I/O 1") {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()!
        // This non-generic function dramatically improves compilation times of complex expressions.
        func fastFloor(_ x: CGFloat) -> CGFloat { return floor(x) }
    ...
    @objc dynamic public class func drawOscillator(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 54, height: 33), resizing: ResizingBehavior = .aspectFit, highlight: Bool = false, joinedOutputPin: CGFloat = 0, outputPinVisible: CGFloat = 1) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()!
        ...
        //// Group
        //// Rectangle Drawing
        let rectanglePath = UIBezierPath(roundedRect: CGRect(x: 2.5, y: 5.5, width: 25, height: 21), cornerRadius: 6)
        colour.setStroke()
        rectanglePath.lineWidth = 2.5
        rectanglePath.stroke()
