...
//  LogicBLOX
//
//  Created by Mike Griebling on 24 Sep 2017.
...
public class Gates : NSObject {
    ...
    @objc dynamic public class func drawBufferInverterGate(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 102, height: 57), resizing: ResizingBehavior = .aspectFit, highlight: Bool = false, joinedPin: CGFloat = 0, joinedOutputPin: CGFloat = 0, inputPinVisible: CGFloat = 0, outputPinVisible: CGFloat = 1, invert: Bool = true) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()!
    ...
    @objc dynamic public class func imageOfOrNorGate(highlight: Bool = false, inputs: CGFloat = 4, joinedPin: CGFloat = 0, joinedOutputPin: CGFloat = 0, inputPinVisible: CGFloat = 0, outputPinVisible: CGFloat = 1, invert: Bool = true) -> UIImage {
    ...
    @objc dynamic public class func imageOfXorXnorGate(highlight: Bool = false, inputs: CGFloat = 4, joinedPin: CGFloat = 0, joinedOutputPin: CGFloat = 0, inputPinVisible: CGFloat = 0, outputPinVisible: CGFloat = 1, invert: Bool = true) -> UIImage {
    ...
    @objc dynamic public class func imageOfBufferInverterGate(highlight: Bool = false, joinedPin: CGFloat = 0, joinedOutputPin: CGFloat = 0, inputPinVisible: CGFloat = 0, outputPinVisible: CGFloat = 1, invert: Bool = true) -> UIImage {
    ...
    @objc dynamic public class func imageOfAndNandGate(highlight: Bool = false, inputs: CGFloat = 4, joinedPin: CGFloat = 0, joinedOutputPin: CGFloat = 0, inputPinVisible: CGFloat = 0, outputPinVisible: CGFloat = 1, invert: Bool = true) -> UIImage {
    ...
    @objc dynamic public class func imageOfBlockGate(highlight: Bool = false, inputs: CGFloat = 4, outputs: CGFloat = 1, joinedPin: CGFloat = 0, joinedOutputPin: CGFloat = 0, inputPinVisible: CGFloat = 0, outputPinVisible: CGFloat = 1, name: String = "Block Gate") -> UIImage {
    ...
    @objc dynamic public class func imageOfIndicator(highlight: Bool = false, state: CGFloat = 0, joinedPin: CGFloat = 0, inputPinVisible: CGFloat = 0) -> UIImage {
