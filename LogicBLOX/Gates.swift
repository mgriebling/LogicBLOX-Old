...
//  LogicBLOX
//
//  Created by Mike Griebling on 11 Sep 2017.
...
public class Gates : NSObject {
    ...
    @objc dynamic public class func drawOrNorGate(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 135, height: 67), resizing: ResizingBehavior = .aspectFit, highlight: Bool = false, pinVisible: Bool = true, inputs: CGFloat = 4, invert: Bool = true) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()!
        ...
        if (notInvert) {
            ...
            Gates.drawOutputPin(frame: CGRect(origin: .zero, size: symbol3Rect.size), resizing: .stretch, highlight: false, pinVisible: true)
            context.restoreGState()
        }
        ...
        Gates.drawOrPins(frame: CGRect(origin: .zero, size: symbol2Rect.size), resizing: .stretch, highlight: highlight, pinVisible: pinVisible, inputs: inputs)
        context.restoreGState()
        ...
        if (invert) {
            ...
            Gates.drawInvertingOutputPin(frame: CGRect(origin: .zero, size: symbol4Rect.size), resizing: .stretch, highlight: highlight, pinVisible: pinVisible)
            context.restoreGState()
        }
    ...
    @objc dynamic public class func drawXorXnorGate(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 143, height: 67), resizing: ResizingBehavior = .aspectFit, highlight: Bool = false, pinVisible: Bool = true, inputs: CGFloat = 4, invert: Bool = true) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()!
    ...
    @objc dynamic public class func drawBufferInverterGate(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 102, height: 57), resizing: ResizingBehavior = .aspectFit, highlight: Bool = false, pinVisible: Bool = true, invert: Bool = true) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()!
        ...
        Gates.drawInputPin(frame: CGRect(origin: .zero, size: symbol2Rect.size), resizing: .stretch, highlight: highlight, pinVisible: pinVisible)
        context.restoreGState()
    ...
    @objc dynamic public class func drawAndNandGate(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 134, height: 68), resizing: ResizingBehavior = .aspectFit, highlight: Bool = false, pinVisible: Bool = true, inputs: CGFloat = 4, invert: Bool = true) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()!
        ...
        Gates.drawAndPins(frame: CGRect(origin: .zero, size: symbolRect.size), resizing: .stretch, highlight: highlight, pinVisible: pinVisible, inputs: inputs)
        context.restoreGState()
    ...
    @objc dynamic public class func drawBlockGate(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 146, height: 141), resizing: ResizingBehavior = .aspectFit, highlight: Bool = false, pinVisible: Bool = true, inputs: CGFloat = 4, name: String = "Block Gate") {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()!
        
        //// Resize to Target Frame
        context.saveGState()
        let resizedFrame: CGRect = resizing.apply(rect: CGRect(x: 0, y: 0, width: 146, height: 141), target: targetFrame)
        context.translateBy(x: resizedFrame.minX, y: resizedFrame.minY)
        context.scaleBy(x: resizedFrame.width / 146, y: resizedFrame.height / 141)
        ...
        //// Rectangle Drawing
        let rectangleRect = CGRect(x: 39, y: 13, width: 72, height: 109)
        ...
        //// Symbol Drawing
        let symbolRect = CGRect(x: 12, y: 13, width: 30, height: 56)
        context.saveGState()
        context.clip(to: symbolRect)
        context.translateBy(x: symbolRect.minX, y: symbolRect.minY)
        ...
        //// Symbol 2 Drawing
        let symbol2Rect = CGRect(x: 12, y: 67, width: 30, height: 56)
        context.saveGState()
        context.clip(to: symbol2Rect)
        context.translateBy(x: symbol2Rect.minX, y: symbol2Rect.minY)

        Gates.drawAndPins(frame: CGRect(origin: .zero, size: symbol2Rect.size), resizing: .stretch, highlight: highlight, pinVisible: pinVisible, inputs: inputs)
        context.restoreGState()


        //// Symbol 3 Drawing
        let symbol3Rect = CGRect(x: 108, y: 30, width: 31, height: 8)
        context.saveGState()
        context.clip(to: symbol3Rect)
        context.translateBy(x: symbol3Rect.minX, y: symbol3Rect.minY)
        ...
        //// Symbol 4 Drawing
        let symbol4Rect = CGRect(x: 108, y: 97, width: 31, height: 8)
        context.saveGState()
        context.clip(to: symbol4Rect)
        context.translateBy(x: symbol4Rect.minX, y: symbol4Rect.minY)
    ...
    @objc dynamic public class func drawButton(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 95, height: 69), resizing: ResizingBehavior = .aspectFit, highlight: Bool = false, pinVisible: Bool = true, state: CGFloat = 0, name: String = "Block Gate") {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()!
        
        //// Resize to Target Frame
        context.saveGState()
        let resizedFrame: CGRect = resizing.apply(rect: CGRect(x: 0, y: 0, width: 95, height: 69), target: targetFrame)
        context.translateBy(x: resizedFrame.minX, y: resizedFrame.minY)
        context.scaleBy(x: resizedFrame.width / 95, y: resizedFrame.height / 69)
        let resizedShadowScale: CGFloat = min(resizedFrame.width / 95, resizedFrame.height / 69)
        ...
        let buttonFill = stateText == "1" ? buttonHi : buttonLo

        //// Group
        //// Rectangle Drawing
        let rectangleRect = CGRect(x: 18, y: 19, width: 49, height: 42)
        ...
        //// Symbol Drawing
        let symbolRect = CGRect(x: 64, y: 36, width: 31, height: 8)
        context.saveGState()
        context.clip(to: symbolRect)
        context.translateBy(x: symbolRect.minX, y: symbolRect.minY)

        Gates.drawOutputPin(frame: CGRect(origin: .zero, size: symbolRect.size), resizing: .stretch, highlight: highlight, pinVisible: pinVisible)
        context.restoreGState()


        //// Text Drawing
        let textRect = CGRect(x: 0, y: 0, width: 90, height: 19)
    ...
    @objc dynamic public class func drawIndicator(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 94, height: 73), resizing: ResizingBehavior = .aspectFit, highlight: Bool = false, pinVisible: Bool = true, state: CGFloat = 0, name: String = "Block Gate") {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()!
        
        //// Resize to Target Frame
        context.saveGState()
        let resizedFrame: CGRect = resizing.apply(rect: CGRect(x: 0, y: 0, width: 94, height: 73), target: targetFrame)
        context.translateBy(x: resizedFrame.minX, y: resizedFrame.minY)
        context.scaleBy(x: resizedFrame.width / 94, y: resizedFrame.height / 73)
        let resizedShadowScale: CGFloat = min(resizedFrame.width / 94, resizedFrame.height / 73)
        ...
        //// Group
        //// Oval Drawing
        let ovalRect = CGRect(x: 27, y: 19, width: 49, height: 47)
        ...
        context.drawRadialGradient(gradientFill,
            startCenter: CGPoint(x: 51.5, y: 42.5), startRadius: 13.06,
            endCenter: CGPoint(x: 51.5, y: 42.5), endRadius: 30.93,
        ...
        let ovalTextHeight: CGFloat = stateText.boundingRect(with: CGSize(width: ovalRect.width, height: CGFloat.infinity), options: .usesLineFragmentOrigin, attributes: ovalFontAttributes, context: nil).height
        context.saveGState()
        context.clip(to: ovalRect)
        stateText.draw(in: CGRect(x: ovalRect.minX, y: ovalRect.minY + (ovalRect.height - ovalTextHeight) / 2, width: ovalRect.width, height: ovalTextHeight), withAttributes: ovalFontAttributes)
        context.restoreGState()


        //// Symbol Drawing
        let symbolRect = CGRect(x: 0, y: 39, width: 27, height: 8)
        context.saveGState()
        context.clip(to: symbolRect)
        context.translateBy(x: symbolRect.minX, y: symbolRect.minY)

        Gates.drawInputPin(frame: CGRect(origin: .zero, size: symbolRect.size), resizing: .stretch, highlight: highlight, pinVisible: pinVisible)
        context.restoreGState()


        //// Text Drawing
        let textRect = CGRect(x: 4, y: 0, width: 90, height: 19)
        let textStyle = NSMutableParagraphStyle()
        textStyle.alignment = .center
        let textFontAttributes = [
            NSFontAttributeName: UIFont.systemFont(ofSize: UIFont.labelFontSize),
    ...
    @objc dynamic public class func drawPin(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 6, height: 6), resizing: ResizingBehavior = .aspectFit, pinVisible: Bool = true) {
        ...
        if (pinVisible) {
            //// Rectangle Drawing
            let rectanglePath = UIBezierPath(rect: CGRect(x: 0.5, y: 0.5, width: 5, height: 5))
    ...
    @objc dynamic public class func drawOrPins(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 31, height: 56), resizing: ResizingBehavior = .aspectFit, highlight: Bool = false, pinVisible: Bool = true, inputs: CGFloat = 4) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()!
        ...
        let hasInputs1or3 = hasInputs3 || inputs == 1
        ...
        if (hasInputs3or4) {
            ...
            Gates.drawInputPin(frame: CGRect(origin: .zero, size: symbol3Rect.size), resizing: .stretch, highlight: highlight, pinVisible: pinVisible)
            context.restoreGState()
            ...
            Gates.drawInputPin(frame: CGRect(origin: .zero, size: symbol4Rect.size), resizing: .stretch, highlight: highlight, pinVisible: pinVisible)
            context.restoreGState()
        }
        ...
        if (hasInputs1or3) {
            ...
            Gates.drawInputPin(frame: CGRect(origin: .zero, size: symbol5Rect.size), resizing: .stretch, highlight: highlight, pinVisible: pinVisible)
            context.restoreGState()
        }
        ...
        if (hasInputs4) {
            ...
            Gates.drawInputPin(frame: CGRect(origin: .zero, size: symbol6Rect.size), resizing: .stretch, highlight: highlight, pinVisible: pinVisible)
            context.restoreGState()
            ...
            Gates.drawInputPin(frame: CGRect(origin: .zero, size: symbol7Rect.size), resizing: .stretch, highlight: highlight, pinVisible: pinVisible)
            context.restoreGState()
        }
    ...
    @objc dynamic public class func drawAndPins(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 30, height: 56), resizing: ResizingBehavior = .aspectFit, highlight: Bool = false, pinVisible: Bool = true, inputs: CGFloat = 4) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()!
    ...
    @objc dynamic public class func drawInputPin(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 27, height: 8), resizing: ResizingBehavior = .aspectFit, highlight: Bool = false, pinVisible: Bool = true) {
        ...
        if (pinVisible) {
            ...
            Gates.drawPin(frame: CGRect(origin: .zero, size: symbol2Rect.size), resizing: .stretch, pinVisible: pinVisible)
            context.restoreGState()
        }
    ...
    @objc dynamic public class func drawAndWithIOGate(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 118, height: 68), resizing: ResizingBehavior = .aspectFit, highlight: Bool = false) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()!
        
        //// Resize to Target Frame
        context.saveGState()
        let resizedFrame: CGRect = resizing.apply(rect: CGRect(x: 0, y: 0, width: 118, height: 68), target: targetFrame)
        context.translateBy(x: resizedFrame.minX, y: resizedFrame.minY)
        context.scaleBy(x: resizedFrame.width / 118, y: resizedFrame.height / 68)
        ...
        //// Symbol 2 Drawing
        let symbol2Rect = CGRect(x: 15, y: 0, width: 86, height: 68)
        context.saveGState()
        context.clip(to: symbol2Rect)
        context.translateBy(x: symbol2Rect.minX, y: symbol2Rect.minY)
        ...
        outputPath.move(to: CGPoint(x: 95, y: 34))
        outputPath.addLine(to: CGPoint(x: 118, y: 34))
        colour.setStroke()
        outputPath.lineWidth = 2.5
        outputPath.stroke()


        //// input Drawing
        let inputPath = UIBezierPath()
        inputPath.move(to: CGPoint(x: 0, y: 34))
        inputPath.addLine(to: CGPoint(x: 23, y: 34))
        colour.setStroke()
        inputPath.lineWidth = 2.5
        inputPath.stroke()
    ...
    @objc dynamic public class func imageOfOrNorGate(highlight: Bool = false, pinVisible: Bool = true, inputs: CGFloat = 4, invert: Bool = true) -> UIImage {
        UIGraphicsBeginImageContextWithOptions(CGSize(width: 135, height: 67), false, 0)
            Gates.drawOrNorGate(highlight: highlight, pinVisible: pinVisible, inputs: inputs, invert: invert)
    ...
    @objc dynamic public class func imageOfXorXnorGate(highlight: Bool = false, pinVisible: Bool = true, inputs: CGFloat = 4, invert: Bool = true) -> UIImage {
        UIGraphicsBeginImageContextWithOptions(CGSize(width: 143, height: 67), false, 0)
            Gates.drawXorXnorGate(highlight: highlight, pinVisible: pinVisible, inputs: inputs, invert: invert)
    ...
    @objc dynamic public class func imageOfBufferInverterGate(highlight: Bool = false, pinVisible: Bool = true, invert: Bool = true) -> UIImage {
        UIGraphicsBeginImageContextWithOptions(CGSize(width: 102, height: 57), false, 0)
            Gates.drawBufferInverterGate(highlight: highlight, pinVisible: pinVisible, invert: invert)
    ...
    @objc dynamic public class func imageOfAndNandGate(highlight: Bool = false, pinVisible: Bool = true, inputs: CGFloat = 4, invert: Bool = true) -> UIImage {
        UIGraphicsBeginImageContextWithOptions(CGSize(width: 134, height: 68), false, 0)
            Gates.drawAndNandGate(highlight: highlight, pinVisible: pinVisible, inputs: inputs, invert: invert)
    ...
    @objc dynamic public class func imageOfBlockGate(highlight: Bool = false, pinVisible: Bool = true, inputs: CGFloat = 4, name: String = "Block Gate") -> UIImage {
        UIGraphicsBeginImageContextWithOptions(CGSize(width: 146, height: 141), false, 0)
    ...
    @objc dynamic public class func imageOfButton(highlight: Bool = false, pinVisible: Bool = true, state: CGFloat = 0, name: String = "Block Gate") -> UIImage {
        UIGraphicsBeginImageContextWithOptions(CGSize(width: 95, height: 69), false, 0)
            Gates.drawButton(highlight: highlight, pinVisible: pinVisible, state: state, name: name)
    ...
    @objc dynamic public class func imageOfIndicator(highlight: Bool = false, pinVisible: Bool = true, state: CGFloat = 0, name: String = "Block Gate") -> UIImage {
        UIGraphicsBeginImageContextWithOptions(CGSize(width: 94, height: 73), false, 0)
            Gates.drawIndicator(highlight: highlight, pinVisible: pinVisible, state: state, name: name)
    ...
    @objc dynamic public class func imageOfAndWithIOGate(highlight: Bool = false) -> UIImage {
        UIGraphicsBeginImageContextWithOptions(CGSize(width: 118, height: 68), false, 0)
            Gates.drawAndWithIOGate(highlight: highlight)

        let imageOfAndWithIOGate = UIGraphicsGetImageFromCurrentImageContext()!
        UIGraphicsEndImageContext()

        return imageOfAndWithIOGate
    }
